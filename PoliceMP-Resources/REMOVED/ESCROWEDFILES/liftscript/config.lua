...
ZONES = {
    ...
    ['mz_ambulance_garage_01'] = {
        ...
        directions = {
            ...
            --St thomas--
    ['Ground_Level_A&E'] = {
        label = "Ground Level A&E",
        coords = vec4(340.0008, -588.9524, 28.80112, -20.36971),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'Main_Hospital_Level',
    ...
    ['Main_Hospital_Level'] = {
        label = "Main Hospital Level",
        coords = vec4(327.3201, -567.7244, 43.39662, 158.8895),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'Top_garden_Level',
    ...
    ['Office_Level'] = {
        label = "Office Level",
        coords = vec4(334.8465, -573.9628, 57.81936, 163.5079),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'Top_garden_Level',
    ...
    ['Helipad_Level'] = {
        label = "Helipad Level",
        coords = vec4(323.9078, -581.2203, 75.72496, -19.84108),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'Top_garden_Level',
    ...
    ['Top_garden_Level'] = {
        label = "Top garden Level",
        coords = vec4(319.3636, -567.2566, 95.84135, 160.0435),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'Helipad_Level',
