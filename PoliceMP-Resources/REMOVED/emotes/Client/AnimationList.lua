...
-- For tablets, I recommand not to use dpemotes but to add each tablets and pills in your own script (request animation, create object etc)
   ["eat_pills"] = {"eat@pills@anim", "eat_pills_clip", "Take pills", AnimationOptions =
   {
   ...
   ["radio_look"] = {"radiography@animation", "radio_clip", "Look radiography", AnimationOptions =
   {
   ...
   ["bandage3"] = {"self@bandage@leg", "self_leg_clip", "Bandage3", AnimationOptions =
   {
      ...
      ["talkradio"] = {"mdx@radiohold", "mdx_radiohold_clip", "Radio Hold", AnimationOptions =
  {
      EmoteLoop = true,
      EmoteMoving = true,
  }},
      ["tapBWV"] = {"mdx@bwvtap", "mdx_bwvtap_clip", "tapBWV", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
DP.Emotes = {
   ...
   ["taserdraw"] = {"export@taserback", "Head_000_r", "taserdraw", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["stopvehicle"] = {"export@stopvehicle", "Head_000_r", "stopvehicle", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["batonhold"] = {"export@batonhold", "Head_000_r", "export@batonhold", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
