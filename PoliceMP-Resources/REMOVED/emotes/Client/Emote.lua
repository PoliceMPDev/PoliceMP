...
Citizen.CreateThread(function()
  while true do
    ...
    if PtfxPrompt then
      ...
      if IsUsingKeyboard(0) and IsControlPressed(0, 47) then
        PtfxStart()
        Wait(PtfxWait)
        PtfxStop()
      end
    ...
    if Config.MenuKeybindEnabled and IsUsingKeyboard(0) then if IsControlPressed(0, Config.MenuKeybind) then OpenEmoteMenu() end end
    if Config.EnableXtoCancel and IsUsingKeyboard(0) then if IsControlPressed(0, 73) then EmoteCancel() end end
    Citizen.Wait(1)
  end
end)
