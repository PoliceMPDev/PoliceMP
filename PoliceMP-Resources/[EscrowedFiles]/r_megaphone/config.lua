...
Config = {
    ...
    Compatibility = {
        ...
        Others = {
            ...
            distance = 50.0, -- Distance to speak (when you use pma-voice, modify directly the distance in the @pma-voice/client/megaphone.lua file of the pma-voice script, for more information please refer to our documentation)
