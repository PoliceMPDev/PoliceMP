config = {
	...
	-- Menu type for whether you would like EU based options
	menuType = "UK",
	useEU = false,
	cctvKeys = {
		up = {0, 172},
    ...
    developerMode = false,
	saveDefaultSpeedsToJson = true, --  If this is set to true, all new speeds will change to default speeds. This'll keep the speeds set after restarts.
	...
	resetSignCommand = "resetsmartmotorway",
    ...
    symbolModels = {
		["UK"] = {
			...
			[50] = "speed_50",
			[60] = "speed_60",
			[70] = "national_speed", -- NSL sign instead of numerical value for 70 (for uk communities)
		},
		["EU"] = {
			[1] = "arrow_left",
			[2] = "arrow_right",
