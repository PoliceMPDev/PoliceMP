...
function nearAccessPoint(k, v, ped, pedCoords)
    Draw3DText(v.coords.x + config.main.signOffset[1], v.coords.y + config.main.signOffset[2], v.coords.z + config.main.signOffset[3], config.main.instructionalText, 4, 0.05, 0.05)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k, v in pairs(locations) do
            local signCoords = vector3(v.coords.x, v.coords.y, v.coords.z)
