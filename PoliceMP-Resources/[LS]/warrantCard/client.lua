Citizen.CreateThread(function()
    if config.UK then
		...
		RegisterCommand('warrant', function()
			TriggerEvent('JPStudiosBadge:client:animation')
		end)
    end
end)
...
print("Made by JP Studios")
print("Script made by Alfie Buckley/Jay Park")

RegisterNetEvent('JPStudiosBadge:client:animation')
AddEventHandler('JPStudiosBadge:client:animation', function()
    Citizen.CreateThread(function()
