...
function GenerateCamMenu()
    ...
    local itemShowHUD = NativeUI.CreateCheckboxItem(Cfg.strings.showHUD, not IsHudHidden(), Cfg.strings.showHUDDesc)
    camMenu:AddItem(itemShowHUD)
    ...
    itemShowHUD.CheckboxEvent = function(menu, item, checked)
        ToggleHud(checked)
    end
