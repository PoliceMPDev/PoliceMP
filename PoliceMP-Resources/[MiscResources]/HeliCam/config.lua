...
Config.CameraTransitionTime = 500 -- The time the transition/ease will take.
...
Config.ForceCameraLabel = Label -- false or "Label"
Config.CanUseAnyHelicopter = true -- If true, any helicopter can be used, if false, only helicopters in the Config.Helicopters table are allowed.
...
Config.CameraLockBreakTicks = 999 -- The maximum amount of ticks the camera can lose visual of the point/person/vehicle before it breaks.
...
Config.Spotlight = {
    ...
    DefaultBrightness = 10.0,                -- The defult brightness of the spotlight
    ...
    DefaultRadius = 3.0,                   -- The defult radius/size of the spotlight
    MinRadius = 3.0,                        -- The minimum radius of the spotlight
...
Config.ZoomBarOffset = 30 -- The offset in % from the bottom of the screen the zoom bar will be when the minimap is enabled. (If you have something on the top of your minimap then setting it to 25 usally works well)
Config.TargetBlip = {
    Display = true,
    Sprite = 390,
    Colour = 40
...
Config.Units = {
    ...
    TargetDistance = "FT" -- The distance from the helicopter to the target      (unit type: distance)
}
...
Config.Helicopters = {
    ...
    [353883353] = {
        ...
        labels = { -- Liveries
            [0] = "National Police Air Service" -- 0 is default
        }
    },
    -- NPAS Dauphin
    [GetHashKey("addpolmh65")] = {
        offset = vector3(0.0, 2.65, -1.0),
        labels = { -- Liveries
            [0] = "National Police Air Service" -- 0 is default
        }
    ...
    [GetHashKey("as332")] = {
        offset = vector3(0.0, 2.65, -1.0),
        labels = { -- Liveries
            [0] = "Maritime and Coastguard Agency" -- 0 is default
        }
    },
    [GetHashKey("AW139")] = {
        offset = vector3(0.0, 2.65, -1.0),
