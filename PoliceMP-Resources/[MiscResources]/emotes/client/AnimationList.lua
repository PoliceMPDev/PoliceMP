...
["highlow2"] = {"anim@highlow_high_lean", "high_lean_clip", "High-Low High Stance (Smos)", AnimationOptions =
{
    EmoteLoop = true,
    EmoteMoving = false,
}},["belt1cs"] = {"custom@BeltCS1", "tpm1_clip", "Belt 1 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt1taser"] = {"custom@TB1", "tpm3_clip", "Belt 1 Taser", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["belt2cs"] = {"custom@BeltCS2", "tpm4_clip", "Belt 2 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt2taser"] = {"custom@TB2", "tpm5_clip", "Belt 2 Taser", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["belt3cs"] = {"custom@BeltCS3", "tpm7_clip", "Belt 3 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt3baton"] = {"custom@ASPB3", "tpm6_clip", "Belt 3 Baton", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt3taser"] = {"custom@TB3", "tpm8_clip", "Belt 3 Taser", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["belt4cs"] = {"custom@BeltCS4", "tpm9_clip", "Belt 4 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt4taser"] = {"custom@TB4", "tpm10_clip", "Belt 4 Taser", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["belt5cs"] = {"custom@BCS5", "tpm12_clip", "Belt 5 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt5baton"] = {"custom@ASPB5", "tpm11_clip", "Belt 5 Baton", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt5taser"] = {"custom@TB5", "tpm13_clip", "Belt 5 Taser", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["belt7baton"] = {"custom@ASPB7", "tpm14_clip", "Belt 7 Baton", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["belt7taser"] = {"custom@TB7", "tpm15_clip", "Belt 7 Taser", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["beltn1baton"] = {"custom@ASPNB1", "tpm38_clip", "Non Taser Belt 1 Baton", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["beltn1cs"] = {"custom@NCS1", "tpm39_clip", "Non Taser Belt 1 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["beltn2baton"] = {"custom@ASPNB2", "tpm40_clip", "Non Taser Belt 2 Baton", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["beltn2cs"] = {"custom@NCS2", "tpm41_clip", "Non Taser Belt 2 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["beltn3baton"] = {"custom@ASPNB3", "tpm42_clip", "Non Taser Belt 3 Baton", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["beltn3cs"] = {"custom@NCS3", "tpm43_clip", "Non Taser Belt 3 CS", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["beltn4baton"] = {"custom@ASPNB4", "Non Taser Belt 4 Baton", "animation", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["hivisradio1"] = {"custom@HVPTTL", "tpm30_clip", "HiVis PTT Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},

["hivisradio2"] = {"custom@HVPTT", "tpm32_clip", "HiVis PTT Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["vestradio1"] = {"custom@NVPTTL", "tpm29_clip", "Vest PPT Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["vestradio2"] = {"custom@NVPTT", "tpm34_clip", "Vest PPT Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["vestbwvon1"] = {"custom@NVOn", "tpm21_clip", "Vest BWV On Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},

["vestbwvon2"] = {"custom@NVOnL", "tpm36_clip", "Vest BWV On Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
["vestbwvoff1"] = {"custom@NVOFF", "tpm20_clip", "Vest BWV Off Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
["vestbwvoff2"] = {"custom@NVOFFL", "tpm26_clip", "Vest BWV Off Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
["hivisbwvon1"] = {"custom@HVONR", "tpm17_clip", "HiVis BWV On Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},

["hivisbwvon2"] = {"custom@HVONL", "tpm23_clip", "HiVis BWV On Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
["hivisbwvoff1"] = {"custom@HVOFFR", "tpm16_clip", "HiVis BWV Off Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},

["hivisbwvoff2"] = {"custom@HVOFFL", "tpm22_clip", "HiVis BWV Off Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
["armrest"] = {"custom@WARM", "tpm56_clip", "Car Arm Rest", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["holdbwv"] = {"custom@CovertBWV", "tpm46_clip", "Hold BWV", AnimationOptions =
   {
       Prop = "prop_cs_bwv",
       PropBone = 28422,
       PropPlacement = {0.075, 0.05, -0.04, 50.0, -160.0, 190.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["handspocket"] = {"custom@HIP", "tpm49_clip", "Hands In Pockets", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["handvest"] = {"custom@HOV", "tpm50_clip", "Hands On Vest", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
["pava"] = {"custom@PCS", "tpm47_clip", "Pava Point", AnimationOptions =
   {
       Prop = "prop_cs_pava",
       PropBone = 28422,
       PropPlacement = {0.063, 0.02, -0.025, 100.0, -100.0, 170.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["pava2"] = {"custom@SCS", "tpm48_clip", "Pava Stop", AnimationOptions =
   {
       Prop = "prop_cs_pava",
       PropBone = 28422,
       PropPlacement = {0.063, 0.02, -0.025, 100.0, -100.0, 170.0},
...
["taserhold"] = {"custom@HT1", "tpm54_clip", "Taser Hold", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
...
["vestpanic1"] = {"custom@NVS0L", "tpm28_clip", "Vest Panic Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},

["vestpanic2"] = {"custom@NVS0", "tpm35_clip", "Vest Panic Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
["hivispanic1"] = {"custom@HVS0L", "tpm31_clip", "HiVis Panic Left", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
["hivispanic2"] = {"custom@HVS0", "tpm33_clip", "HiVis Panic Right", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   }},
...
["armswirl"] = {"custom@armswirl", "armswirl", "Dance Armswirl", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
["armwave"] = {"custom@armwave", "armwave", "Dance Armwave", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
["circle_crunch"] = {"custom@circle_crunch", "circle_crunch", "Dance Circle Crunch", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
["dig"] = {"custom@dig", "dig", "Digging", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
["gangnamstyle"] = {"custom@gangnamstyle", "gangnamstyle", "Dance Gangnam Style", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
["makarena"] = {"custom@makarena", "makarena", "Dance Makarena", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
["maraschino"] = {"custom@maraschino", "maraschino", "Dance Maraschino", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
...
["salsa2"] = {"custom@salsa", "salsa", "Dance Salsa", AnimationOptions =
   {
   EmoteLoop = true,
   EmoteMoving = false,
   }},
...
["pchat"] = {"custom@HHS", "tpm51_clip", "PC Hat", AnimationOptions =
   {
       Prop = "prop_cs_pcpeaked",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["insphat"] = {"custom@HHS", "tpm51_clip", "Insp Hat", AnimationOptions =
   {
       Prop = "prop_cs_insppeaked",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["supthat"] = {"custom@HHS", "tpm51_clip", "Supt Hat", AnimationOptions =
   {
       Prop = "prop_cs_suptpeaked",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["pchatt"] = {"custom@HHS", "tpm51_clip", "PC Traffic Hat", AnimationOptions =
   {
       Prop = "prop_cs_pcpeakedt",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["insphatt"] = {"custom@HHS", "tpm51_clip", "Insp Traffic Hat", AnimationOptions =
   {
       Prop = "prop_cs_insppeakedt",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["supthatt"] = {"custom@HHS", "tpm51_clip", "Supt Traffic Hat", AnimationOptions =
   {
       Prop = "prop_cs_suptpeakedt",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["cdrhat"] = {"custom@HHS", "tpm51_clip", "Commander Hat", AnimationOptions =
   {
       Prop = "prop_cs_cdrpeaked",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["commhat"] = {"custom@HHS", "tpm51_clip", "Commissioner Hat", AnimationOptions =
   {
       Prop = "prop_cs_commpeaked",
       PropBone = 2992,
       PropPlacement = {-0.09, 0.05, -0.18, 1.0, 50.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["radioear"] = {"custom@radioear", "tpm53_clip", "Radio Ear", AnimationOptions =
   {
       Prop = "prop_cs_walkie_talkie",
       PropBone = 60309,
       PropPlacement = {0.075, 0.05, 0.01, 50.0, -160.0, 170.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
["defibrillator"] = {"defibrillator@animation", "defib_clip", "Defibrillator", AnimationOptions =
   {
...
["thermo"] = {"take@temperature@anim", "thermo_clip", "Take temperature", AnimationOptions =
   {
...
["syringe"] = {"disinfect@sting@anim", "sting_clip", "Injection", AnimationOptions =
   {
...
["surgery"] = {"surgery@scalpel@anim", "scalpel_clip", "Surgery", AnimationOptions =
   {
...
["bandage1"] = {"bandage@animation@arm", "bandage_arm_clip", "Bandage1", AnimationOptions =
   {
...
["bandage2"] = {"bandage@animation", "bandage_selfarm_clip", "Bandage2", AnimationOptions =
   {
       Prop = "alcaprop_medic_bandage",
       PropBone = 18905,
       PropPlacement = {0.14, 0.02, 0.02, 98.0, -104.0, -158.0},
...
["bandage3"] = {"self@bandage@leg", "self_leg_clip", "Bandage3", AnimationOptions =
   {
       Prop = "alcaprop_medic_bandage",
       PropBone = 18905,
       PropPlacement = {0.14, 0.02, 0.02, 98.0, -104.0, -158.0},
...
["cuzzyonion"] = {"missfbi4prepp1", "_idle_garbage_man", "Cuzzy Onions", AnimationOptions =
   {
