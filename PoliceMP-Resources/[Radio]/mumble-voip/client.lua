				...
				if not mumbleConfig.controls.radio.pressed then
					if IsControlJustPressed(0, mumbleConfig.controls.radio.key) then
						if playerData.radio > 0 then
							TriggerServerEvent('OGRadio:SpeakingOnRadio', true, playerServerId, mumbleConfig.radioChannelNames[playerData.radio])
							...
							Citizen.CreateThread(function()
								...
								TriggerServerEvent('OGRadio:SpeakingOnRadio', false, playerServerId, mumbleConfig.radioChannelNames[playerData.radio])
