...
local menuAllowed = false
RegisterNetEvent("PMP::Game.Notifications.EnableWeaponsEvent")
AddEventHandler("PMP::Game.Notifications.EnableWeaponsEvent", function()
    menuAllowed = true
end)
...
function MenuV:OpenMenu(menu, cb, reopen)
    if (not menuAllowed) then return end
