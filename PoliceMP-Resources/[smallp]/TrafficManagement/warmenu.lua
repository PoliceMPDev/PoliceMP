...
-- Local variables
local menus = { }
local keys = { up = 15, up2 = 172, down = 14, down2 = 173, left = 174, right = 175, select = 176, back = 177 }
...
function WarMenu.Display()
    if isMenuVisible(currentMenu) then
        if menus[currentMenu].aboutToBeClosed then
            ...
            if IsControlJustPressed(0, keys.down) or IsControlJustPressed(0, keys.down2) then
                PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true)
            ...
            elseif IsControlJustPressed(0, keys.up) or IsControlJustPressed(0, keys.up2) then
                PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true)
