...
{
    public class OngoingAssault : Callout
    {
        private const int HAS_WEAPON_CHANCE = 10;

        public OngoingAssault(int id) : base(id)
        {
            Title = "Ongoing Assault";
            Grade = 1;
            Description = "Assault in street.";
            LocationSetting = LocationSetting.GetNextPositionOnSidewalk;
        }

        public override void Setup()
        {
            for (var i = 0; i < PoliceMpRandom.Next(2, 3); i++)
            {
