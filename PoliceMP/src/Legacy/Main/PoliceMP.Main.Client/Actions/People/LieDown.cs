...
{
    public class LieDown : BaseScript
    {
        /// <summary>
        ///     The command used to execute the action.
        /// </summary>
        [Command(Commands.LieDown)]
        private void Command()
        {
            ...
            TriggerEvent(ClientEvents.ACTION_LIE_DOWN, PersonSelector.SelectedPerson.EntityId());
        }

        [EventHandler(ClientEvents.ACTION_LIE_DOWN)]
        private void Execute(int pedHandle)
        {
            ...
            Screen.ShowSubtitle("~b~You: ~w~Get on the ground!");
