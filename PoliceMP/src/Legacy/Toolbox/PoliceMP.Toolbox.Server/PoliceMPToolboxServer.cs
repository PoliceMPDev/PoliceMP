...
namespace PoliceMP.Toolbox.Server
{
    public class PoliceMPToolboxServer : BaseScript
    {
        public PoliceMPToolboxServer()
        {
        }

        /*
        [EventHandler("PoliceMP:requestingRank")]
        private void requestingRank([FromSource] Player player)
        {
            TriggerClientEvent("PoliceMP:recieveRank");
        }
        */
        ...
        public void requestingSpecWhitelisting([FromSource] Player player, bool _command)
        {
            ...
            bool AFOStatus = false, RPUStatus = false, CIDStatus = false, AdminAuth = false, NPASStatus = false, MPUStatus = false, DogStatus = false, NHSStatus = false, FireStatus = false, MODstatus = false, isWhitelisted = false;
            ...
            TriggerClientEvent(player,"PoliceMP:recieveSpecWhitelisting", AFOStatus, RPUStatus, CIDStatus, NPASStatus, MPUStatus, AdminAuth, DogStatus, NHSStatus, FireStatus, MODstatus, isWhitelisted);
