...
{
    public class DrunkBehaviorImplementation : PedBehavior<DrunkBehavior>
    {
        // ReSharper disable once ConvertToPrimaryConstructor
        public DrunkBehaviorImplementation(ITickManager ticks) : base(ticks)
        {
        }
        ...
        protected override async void Start()
        {
            ...
            ThePed.Task.StartScenario(new Random().Next(0, 2) == 0 ? "WORLD_HUMAN_DRINKING" : "WORLD_HUMAN_PARTYING",
                ThePed.Position);
        ...
        protected override async Task Think()
        {
            ...
            API.SetPedMovementClipset(ThePed.Handle, "move_m@drunk@verydrunk", 1f);
