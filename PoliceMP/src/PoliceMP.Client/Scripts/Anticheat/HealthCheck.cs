...
namespace PoliceMP.Client.Scripts.Anticheat
{
    public class HealthCheck : Script
    {
        ...
        public HealthCheck(ILegacyClientCommunicationsManager comms, INotificationService notification,
        ...
        protected override async Task OnStartAsync()
        {
            ...
            _isMod = _userAces.IsModerator || _userAces.IsAdmin || _userAces.IsDevFunNight;
