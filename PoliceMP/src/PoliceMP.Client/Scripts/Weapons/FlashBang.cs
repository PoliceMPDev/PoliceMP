...
namespace PoliceMP.Client.Scripts.Weapons
{
    public class FlashBang : Script
    {
        ...
        public FlashBang(ILegacyClientCommunicationsManager comms, INotificationService notification,
        ...
        private async Task OnReceiveFlashBangEvent(float posX, float posY, float posZ, int stunTime, int afterTime,
        ...
        private async Task HandleNearbyPeds(Vector3 pos, int stunTime, int afterTime)
        {
            int stunRefTime = stunTime * 1000;
            ...
            await Script.Delay(stunRefTime);
        ...
        private async Task PlayParticles(Vector3 pos)
        {
        ...
        private async Task FlashBangThrown(int prop)
        {
