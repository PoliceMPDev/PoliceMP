...
{
    //WOODY LOVES YOU
    public class MultiVehicleRtcCallout : BaseCallout, IAiCallout
    {
        ...
        public MultiVehicleRtcCallout(IBehaviorService behaviors, AiCalloutsPeds peds,
        ...
        {
            return "RTC - Multi vehicle / Motorway";
        }

        public override string Subtitle()
        {
            return "Casualties Reported";
        }

        public override string Body()
        {
            return "Highways England control room: Reporting multi vehicle RTC on carriage way";
        }
        ...
        public override async void OnCreate()
        {
            ...
            vehicleOnFire = API.CreateVehicle(AiCalloutHighwaysList.VehicleModels.GetRandom(),
                _selectedLocation.Item2.X, _selectedLocation.Item2.Y, _selectedLocation.Item2.Z, 50.0f, true, true);
            vehicleOnFire = API.CreateVehicle(AiCalloutHighwaysList.VehicleModels.GetRandom(),
                _selectedLocation.Item2.X, _selectedLocation.Item2.Y, _selectedLocation.Item2.Z, 79.0f, true, true);
            ...
            if (vehiclepedbehaviour != null)
            {
                ...
                foreach (var atendee in _attendees)
                {
                    ...
                    API.TaskWarpPedIntoVehicle(vehiclefireped.Handle, vehicleOnFire, 1);
                ...
                vehiclepedbehaviour.Set(bb => bb.SpeechTicksInterval, 500);
        ...
        public override IAiCallout OnResolve()
        {
            ...
            DeletePedById(brokendownvictim);
        ...
        public override bool CanBeCompleted()
        {
            ...
            API.DoesEntityExist(vehicleOnFire);
