...
{
    public class BTPGunCallout : BaseCallout, IAiCallout
    {
        //***
        //Random gun callout at tube station 
        //***
        ...
        public BTPGunCallout(IBehaviorService behaviors, AiCalloutsPeds peds, IPedInfoService pedInfo, IXPService xpService)
        {
        ...
        {
            return "Individual with firearms at Tube Station";
        }
        ...
        {
            return "Reported a male carrying a firearm in public";
        }

        public override void OnCreate()
        {
            int random = _random.Next(AiCalloutsPeds.AmbientMales.Count);
            Vector3 loneshooterlocation = AiCalloutsLocations.TubeStationFoot.GetRandom();
        ...
        public override async void OnStart()
        {
            ...
            if (loneShooterBehavior != null)
            {
                ...
                loneShooterBehavior.Set(bb => bb.Speeches,
                    new List<string>()
                    {
                        "Yeah mate, I am at the spot", "Who do you want me to hit?", "I can sort you a 9mm",
